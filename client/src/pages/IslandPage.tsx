...
const mock = [
    {
        ...
        title: 'fklll',
        order: 1,
        description: 'Начинаем готовить разметку страницы блога, разбираемся из каких тегов она состоит и за что эти теги отвечают.',
        difficulty: 1,
        progress: 100,
    },
    {
        ...
        title: 'fklll',
        order: 2,
        description: 'Продолжаем верстать страницу блога, изучаем, как правильно размечать текстовое содержание: абзацы, заголовки, подзаголовки, списки и многое другое.gll',
        difficulty: 2,
        progress: 0,
    },
    {
        ...
        title: 'fklll',
        order: 3,
        description: 'Завершаем разметку страницы блога, добавляем навигационные ссылки, а также разбираемся с форматами изображений.',
        difficulty: 3,
        progress: null,
    },
];
        ...
        <section className='islands container'>
            <div className='islands__wrapper content-wrapper'>
                <section className='islands__head'>
                    ...
                    <Button className='island__head-button'>
